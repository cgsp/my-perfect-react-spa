 ...
 * @Last Modified time: 2018-09-27 13:48:02
 */
...
class MainAlbum extends Component {
  ...
  render() {
    ...
    return (
      <div className="main-classfiy">
        {/* 搜索 */}
        {
          hasThisButton('main-classfiy', '查询') ?
            <List className="search-list" bordered>
              ...
              >
                ...
                <Col span={8}>
                  <FormItem
                    className="form-item"
                    label={<span className="form-label">主站分类ID:</span>}
                    colon={false}
                  >
                    <InputNumber
                      ref="searchSourceIdref"
                      style={{ width: 190 }} placeholder="请输入主站分类ID" onChange={v => this.setState({ searchSourceId: v })}
                    />
                  </FormItem>
                </Col>
                <Col span={8}>
