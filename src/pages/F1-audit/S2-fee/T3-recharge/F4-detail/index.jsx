...
export default class MobileDetail extends Component {
  ...
  render() {
    ...
    return (
      <div className="recharge-check-container-detail">
        <BreadcrumbNav {...navData} />
        <div className="recharge-basic-info colum1">
        ...
        <div className="recharge-title">线下汇款审批详情</div>

        <div className="recharge-basic-info">
