...
export default class MobileAudit extends Component {
    ...
    handleSubmit = e => {
        const basicAppInfo = sessionCache.get('highLinesMobileData') || {}
    ...
    render() {
        ...
        return (
            <div className="mobileApply-edit-container">
                <Breadcrumb>
                    <Breadcrumb.Item>
                        <Link to="/developerAudit/Company" style={{color: 'cornflowerblue'}}>移动&网站应用列表</Link>
                    </Breadcrumb.Item>
                    <Breadcrumb.Item>移动应用上线审批</Breadcrumb.Item>
                </Breadcrumb>
                <div className="mobileApply-title">移动应用上线审批</div>
                ...
                <div className="mobileApply-button">
