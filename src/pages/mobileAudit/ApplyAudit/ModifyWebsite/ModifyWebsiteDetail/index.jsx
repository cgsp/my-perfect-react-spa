...
export default class MobileDetail extends Component {
    ...
    render() {
        ...
        return (
            <div className="modifyWebApply-check-container">
                <Breadcrumb>
                    <Breadcrumb.Item>
                ...
                <div className="modifyWebApply-basic-info colum3">
