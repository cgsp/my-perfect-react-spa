...
@observer
@Form.create({})
export default class MobileAudit extends Component {
    constructor(props){
        super(props)
        this.state={
            isViewModel: false,
        ...
        this.basicAppInfo = sessionCache.get('modifyWebsiteData') || {}
    }

    handleSubmit = e => {
        const basicAppInfo = sessionCache.get('modifyWebsiteData') || {}
    ...
    render() {
        ...
        return (
            <div className="modifyWebApply-edit-container">
                <Breadcrumb>
                    <Breadcrumb.Item>
                ...
                <div className="modifyWebApply-title">应用信息修改审批</div>

                <div className="modifyWebApply-basic-info">
                    <div className="title1">申请内容</div>
                    <Form className="modifyWebApply-form">
                        ...
                        <div className='modifyWebApply-table'>
                ...
                <div className="modifyWebApply-button">
                ...
                <div className="modifyWebApply-basic-info">
                    ...
                    <Form className="modifyWebApply-form">
                        <div className="second-title"><span className="modifyWebApply-form-mark"></span><span>基本信息</span></div>
                        ...
                        <div className="second-title"><span className="modifyWebApply-form-mark"></span><span>合作规范</span></div>
