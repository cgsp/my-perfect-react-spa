...
@Form.create({})
export default class MobileIntellDetail extends Component {
    constructor(props){
        super(props)
    ...
    render() {
        ...
        return (
            <div className="modifyIntellApply-check-container">
                <Breadcrumb>
                    <Breadcrumb.Item>
                        <Link to="/mobileAudit/ApplyAudit" style={{color: 'cornflowerblue'}}>智能硬件应用列表</Link>
                    </Breadcrumb.Item>
                    <Breadcrumb.Item>应用信息修改详情</Breadcrumb.Item>
                </Breadcrumb>
                <div className="modifyIntellApply-basic-info colum1">
                    <div className="title1">审批状态:   <span className="title1-value">{status[this.basicAppInfo.auditState]}</span></div>
                </div>
                <div className="modifyIntellApply-title">应用信息修改详情</div>
                ...
                <div className="modifyIntellApply-basic-info colum3">
