 ...
 * @Last Modified time: 2018-09-05 14:15:14
 */
...
import { apiMainAlbumList, apiMainAlbumDetail, apiMainAlbumAddOrEdit, apiAlbumGetMainPeople } from '@Api/main-album'
          ...
          >
            ...
            <Col span={8}>
              ...
              >
                <InputNumber
                  ref="searchIdref"
                  style={{ width: 190 }} placeholder="请输入主站专辑IDD" onChange={v => this.setState({ searchId: v })}
                />
              </FormItem>
            </Col>
            <Col span={8}>
