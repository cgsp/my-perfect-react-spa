...
class AddAndEdit extends React.Component {
  showCatagoriesAll = () => {
    const { qaCategoryAll } = toJS(this.props.helpTop)
    ...
    return (
      <div>
        <Form onSubmit={handleContentModalOk}>
          ...
          <Item {...formLayout} label="序号" help={isAddContentModel ? `请在1到${secMaxOrderNum + 1}中选择` : `请在1到${secMaxOrderNum ? secMaxOrderNum : secMaxOrderNum + 1}中选择`}>
            ...
            })(<InputNumber min={1} max={isAddContentModel ? secMaxOrderNum + 1 : secMaxOrderNum ? secMaxOrderNum : secMaxOrderNum + 1} placeholder="请填写序号" style={{ width: 110 }} />)}
          </Item>
